...
public class ClientEntitySelectorReader {
    ...
    private BiConsumer<Vec3d, List<? extends Entity>> sorter = ClientEntitySelector.ARBITRARY;
    ...
    public ClientEntitySelectorReader(StringReader reader) {
        this.reader = reader;
    }

    public ClientEntitySelector build() {
        Box box;
        ...
        if (!this.reader.canRead()) {
            ...
            if (switch (c) {
                case 'a' -> {
                    ...
                    this.sorter = ClientEntitySelector.ARBITRARY;
    ...
    protected void readArguments() throws CommandSyntaxException {
        ...
        while (this.reader.canRead() && this.reader.peek() != ']') {
            ...
            int i = this.reader.getCursor();
            String string = this.reader.readString();
            ClientEntitySelectorOptions.SelectorHandler selectorHandler = ClientEntitySelectorOptions.getHandler(this, string, i);
            this.reader.skipWhitespace();
            if (!this.reader.canRead() || this.reader.peek() != '=') {
                this.reader.setCursor(i);
    ...
    public ClientEntitySelector read() throws CommandSyntaxException {
    ...
    private CompletableFuture<Suggestions> suggestOptionOrEnd(SuggestionsBuilder builder, Consumer<SuggestionsBuilder> consumer) {
        builder.suggest(String.valueOf(']'));
        ClientEntitySelectorOptions.suggestOptions(this, builder);
        return builder.buildFuture();
    }
